function LagrangeBase(n::Integer)
    ...
    elseif n==6
            [x->324/5 * x ^ 6 - 1134/5 * x ^ 5 + 315 * x ^ 4 - 441/2 * x ^ 3 + 406/5 * x ^ 2 - 147/10 * x + 1,
             x->-1944/5 * x ^ 6 + 1296 * x ^ 5 - 1674 * x ^ 4 + 1044 * x ^ 3 - 1566/5 * x ^ 2 + 36 * x,
             x->972 * x ^ 6 - 3078 * x ^ 5 + 3699 * x ^ 4 - 4149/2 * x ^ 3 + 1053/2 * x ^ 2 - 45 * x,
             x->-1296 * x ^ 6 + 3888 * x ^ 5 - 4356 * x ^ 4 + 2232 * x ^ 3 - 508 * x ^ 2 + 40 * x,
             x->972 * x ^ 6 - 2754 * x ^ 5 + 2889 * x ^ 4 - 2763/2 * x ^ 3 + 297 * x ^ 2 - 45/2 * x,
             x->-1944/5 * x ^ 6 + 5184/5 * x ^ 5 - 1026 * x ^ 4 + 468 * x ^ 3 - 486/5 * x ^ 2 + 36/5 * x,
             x->324/5 * x ^ 6 - 162 * x ^ 5 + 153 * x ^ 4 - 135/2 * x ^ 3 + 137/10 * x ^ 2 - x],
             [x->1944/5 * x ^ 5 - 1134 * x ^ 4 + 1260 * x ^ 3 - 1323/2 * x ^ 2 + 812/5 * x - 147/10,
             x->-11664/5 * x ^ 5 + 6480 * x ^ 4 - 6696 * x ^ 3 + 3132 * x ^ 2 - 3132/5 * x + 36,
             x->5832 * x ^ 5 - 15390 * x ^ 4 + 14796 * x ^ 3 - 12447/2 * x ^ 2 + 1053 * x - 45,
             x->-7776 * x ^ 5 + 19440 * x ^ 4 - 17424 * x ^ 3 + 6696 * x ^ 2 - 1016 * x + 40,
             x->5832 * x ^ 5 - 13770 * x ^ 4 + 11556 * x ^ 3 - 8289/2 * x ^ 2 + 594 * x - 45/2,
             x->-11664/5 * x ^ 5 + 5184 * x ^ 4 - 4104 * x ^ 3 + 1404 * x ^ 2 - 972/5 * x + 36/5,
             x->1944/5 * x ^ 5 - 810 * x ^ 4 + 612 * x ^ 3 - 405/2 * x ^ 2 + 137/5 * x - 1]                     
    end
end
