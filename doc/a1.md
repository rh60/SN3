...
$$\tag{P1b} \partial_x \rho = \cos \varphi \text{, } \partial_y \rho = \sin \varphi$$
...
$$ \begin{align}  
\rho&=\rho \\,\cos \varphi -\rho^2 \\,\sin \varphi \\, \partial_x \varphi
\\\\  \rho&=y \\,\sin \varphi +\rho^2 \\,\cos \varphi \\, \partial_y \varphi
\end{align}$$
